...
public class main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sha=getSharedPreferences("robi",MODE_PRIVATE);
        String b;
        String a= sha.getString("language","");
        if( a == "" )
        {
            a="en";
        }
        ...
        setContentView(R.layout.geni);
        ImageView image=findViewById(R.id.img1);
        ImageView image1=findViewById(R.id.analytics);
        image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(main.this, Taskadder.class);
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(main.this,Analytics.class);
                startActivity(intent);
            }
        });
    }
