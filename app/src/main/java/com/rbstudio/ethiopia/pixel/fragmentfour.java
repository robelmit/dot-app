...
import com.rbstudio.ethiopia.pixel.view.FourAdapter;
...
public class fragmentfour extends Fragment {
    ...
    private List<Four> notesList = new ArrayList<>();
    private CoordinatorLayout coordinatorLayout;
    private RecyclerView recyclerView;
    private LinearLayout noNotesView;

    private fourdatabase db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db = new fourdatabase(getContext());
        ...
        mAdapter = new FourAdapter(getContext(), notesList);
