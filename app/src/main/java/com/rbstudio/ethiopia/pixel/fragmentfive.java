...
import com.rbstudio.ethiopia.pixel.view.FiveAdapter;
import com.rbstudio.ethiopia.pixel.view.OneAdapter;
...
public class fragmentfive extends Fragment {
    ...
    private FiveAdapter mAdapter;
    private List<Five> notesList = new ArrayList<>();
    private CoordinatorLayout coordinatorLayout;
    private RecyclerView recyclerView;
    private LinearLayout noNotesView;

    private fivedatabase db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db = new fivedatabase(getContext());
        ...
        mAdapter = new FiveAdapter(getContext(), notesList);
    ...
    private void createNote(int note) {
        // inserting note in db and getting
        // newly inserted note id
        long id = db.insertNote(note);

        // get the newly inserted note from db
        Five n = db.getNote(id);
