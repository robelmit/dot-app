...
public class fragmentone extends Fragment {
    ...
    private List<One> notesList = new ArrayList<>();
    private CoordinatorLayout coordinatorLayout;
    private RecyclerView recyclerView;
    private LinearLayout noNotesView;
    ArrayList<Parcelable> nowDataList;
    private onedatabase db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db = new onedatabase(getActivity());
        ...
        mAdapter = new OneAdapter(getContext(), notesList);
