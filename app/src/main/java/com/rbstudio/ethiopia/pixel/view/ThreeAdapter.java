...
public class ThreeAdapter extends RecyclerView.Adapter<ThreeAdapter.MyViewHolder> {
    ...
    public ThreeAdapter(Context context, List<Three> notesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemthree, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Three note = notesList.get(position);
        //let's add the data

        holder.name.setText(note.getAdvert()+" br");
