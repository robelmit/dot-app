...
public class FiveAdapter extends RecyclerView.Adapter<FiveAdapter.MyViewHolder> {

    private Context context;
    private List<Five> notesList;
    ...
    public FiveAdapter(Context context, List<Five> notesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemfive, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Five note = notesList.get(position);
        //let's add the data

        holder.name.setText(note.getOther()+" br");
