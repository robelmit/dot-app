...
import com.rbstudio.ethiopia.pixel.view.ThreeAdapter;
...
public class fragmentthree extends Fragment {
    ...
    private List<Three> notesList = new ArrayList<>();
    private CoordinatorLayout coordinatorLayout;
    private RecyclerView recyclerView;
    private LinearLayout noNotesView;

    private threedatabase db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db = new threedatabase(getContext());
        ...
        mAdapter = new ThreeAdapter(getContext(), notesList);
