...
public class OneAdapter extends RecyclerView.Adapter<OneAdapter.MyViewHolder> {
    ...
    public OneAdapter(Context context, List<One> notesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemone, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        One note = notesList.get(position);
        //let's add the data

        holder.name.setText(note.getRent()+" br");
