...
public class FourAdapter extends RecyclerView.Adapter<FourAdapter.MyViewHolder> {
    ...
    public FourAdapter(Context context, List<Four> notesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemfour, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Four note = notesList.get(position);
        //let's add the data

        holder.name.setText(note.getPayable()+" br");
